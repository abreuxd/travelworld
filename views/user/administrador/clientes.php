            ...
            <div class="col-md-14">
                <div class="card">
                    <div class="card-header text-right">
                        <a class="btn btn-sm btn-primary" href='?page=adm-cliente-editar'>Nuevo</a>
                        <a class="btn btn-sm btn-primary" href='?page=adm-pdf-clientes'>Imprimir tabla</a>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <table class="table">
                            ...
                            while ($row = $cliente->next()) {
                                ...
                                echo "<td>$row->sexo</td>";
                                echo "<td>
                                            <a href='?page=adm-cliente-editar&id=$row->idUsuario'>Editar</a>
                                            <a href='?page=adm-pdf-fichacliente&id=$row->idUsuario'>Ficha</a>
